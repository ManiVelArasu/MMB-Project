...
class _EditorViewState extends State<EditorView> {
  bool _isCanvasBackground(EditorItem item) {
    ...
    // Keep the background identifiable after transform operations.
    return item.id?.startsWith('bg_') == true ||
        ((item.width ?? 0) >= 1000 && (item.height ?? 0) >= 1000);
  }
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return Stack(
                    ...
                    children: [
                      // Render ALL editor items through EditableItemWidget.
                      // Background is a normal EditorItem too, so all existing
                      // transforms, filters, shapes, outline, opacity and layer
                      // actions are applied to it exactly like other images.
                      ...
                      // Keep the selected-background outline without changing
                      // the existing editor design.
